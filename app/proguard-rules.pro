...
-keep public class * extends android.app.remark.BackupAgentHelper
...
-keep public class com.boredream.koalatrace.R$*{
...
#项目中不需要混淆的
-keep class com.boredream.koalatrace.data.**{*;}
-keep class com.boredream.koalatrace.view.**{*;}
-keep class com.boredream.koalatrace.db.**{*;}
-keep class com.boredream.koalatrace.di.**{*;}
-keep class com.boredream.koalatrace.net.**{*;}

# Keep options for AndroidX support libraries.
-keep class androidx.** { *; }
-dontwarn androidx.**

# Keep options for material design support libraries.
-keep class com.google.android.material.** { *; }
-dontwarn com.google.android.material.**

# Keep options for Room database library.
-keep class androidx.room.** { *; }
-keepclassmembers class androidx.room.** { *; }
-dontwarn androidx.room.**

# Keep options for Hilt dependency injection library.
-keep class dagger.hilt.** { *; }
-keepclassmembers class dagger.hilt.** { *; }
-dontwarn dagger.hilt.**

# Keep options for AMap location and map SDK.
